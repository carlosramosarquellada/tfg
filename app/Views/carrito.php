                  ...
                  <div class="p-5">
                    ...
                    <div class="row mb-4 d-flex justify-content-between align-items-center">
                      <div class="col-md-2 col-lg-2 col-xl-2">
                        <img src="<?php echo base_url('uploads/'.$product->imagen) ?>" class="img-fluid rounded-3" alt="Cotton T-shirt">
                      </div>
                      <div class="col-md-3 col-lg-3 col-xl-3">
                      
                        <h6 class="text-black mb-0"><?php echo $product->nombre ?>
                        <?php foreach($promociones as $promocion): ?>
                          <?php if($promocion->product_id == $item->product_id):?>
                            <div class="alert alert-success col-8 text-center" style="position: absolute; padding:0">PROMOCIÓN</div>
                           <?php endif;?>
                        <?php endforeach; ?></h6>
                      </div>
                      ...
                      <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                        <h6 class="mb-0"> <?php echo number_format(($item->precio*$item->qty),2,',','.').'€' ?></h6>
                      </div>
                    ...
                    <div class="pt-5">
                      <h6 class="mb-0"><a href="<?php echo base_url('tienda')?>" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Volver a la tienda</a></h6>
                    </div>
                  </div>
                </div>
